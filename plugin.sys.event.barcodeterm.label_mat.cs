#line 2
       ...
       #region PLUGIN_BODY
        ...
        const string FILE = "plugin.sys.event.barcodeterm.label_mat.pls";
        ...
        class _SETTINGS : TOOL_SETTINGS
        {
            ...
            public class _BUF
            {
                public static void LOAD_SETTINGS(_PLUGIN PLUGIN)
                {
                    ...
                    x.MY_BARCODETERM_LABELMAT_USER = s.MY_BARCODETERM_LABELMAT_USER;
                ...
                public string MY_BARCODETERM_LABELMAT_USER;
            ...
            public string MY_BARCODETERM_LABELMAT_USER
            {
                get
                {
                    return (_GET("MY_BARCODETERM_LABELMAT_USER", "1,2"));
                }
                set
                {
                    _SET("MY_BARCODETERM_LABELMAT_USER", value);
                }
            ...
            public static bool ISUSEROK(_PLUGIN pPLUGIN)
            {
                return Array.IndexOf<string>(
                     EXPLODELIST(BUF.MY_BARCODETERM_LABELMAT_USER),
        ...
        public class TEXT
        {
            public const string text_DESC = "POS Label Material";
        ...
        const string event_BARCODETERM_BARCODEPRINT = "_barcodeterm_barcodeprint_print";
        ...
        void MY_SYS_NEWFORM_INTEGRATE(Form FORM)
        {
			...
			{ "CmdText" ,"event name::"+event_BARCODETERM_BARCODEPRINT},
			{ "Text" ,"T_LABEL - T_MATERIAL"},
			{ "ImageName" ,"barcode_32x32"},
		    { "Name" ,FILE+".label_material"},
            };
        ...
        public void MY_SYS_USEREVENT_HANDLER(string EVENTCODE, object[] ARGS) //adapter start
        {
            ...
            try
            {
                    ...
                    switch (cmd)
                {
                    ...
                    case event_BARCODETERM_BARCODEPRINT:
                        {
